...
class Carps(Eukaryote, Animals, Chordata, Ray_finned, Cypriniformes, Cyprinidae, Abramis):
    def info_carps(self):
...
class Atlantic_Herring(Eukaryote, Animals, Chordata, Ray_finned, Clupeiformes, Clupea):
